...
export function PreviewCard({ artifactId, title, mimeType, fileSize, url, previewUrl, onEdit, sourceAgentId, sourceAgentName, sourceMessageId }: Props) {
  ...
  function sendToChat() {
    if (!content) return;
    window.dispatchEvent(new CustomEvent("agenthub:code-to-chat", {
      detail: {
        code: content,
        title,
