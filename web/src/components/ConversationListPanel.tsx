...
export function ConversationListPanel() {
  ...
  return (
    <aside className="w-80 min-w-80 max-w-80 bg-panel flex flex-col min-h-0 shrink-0 overflow-hidden border-r border-border">
            ...
            >
              ...
              <div className="mt-2 flex items-center justify-between gap-2">
                ...
                <button
                  ...
                  className="rounded border border-border px-2 py-1 text-[10px] text-muted transition hover:border-accent/60 hover:text-fg"
                >
                  Edit
                </button>
              </div>
